...
class SysllabusMain extends StatefulWidget {
  @override
  _SysllabusMainState createState() => _SysllabusMainState();
}

class _SysllabusMainState extends State<SysllabusMain> {
  ...
  final List<String> pdfnames = <String>[
    '/JEE Mains syllabus/physics_jee_mains_sysllabus.pdf',
    '/JEE Mains syllabus/chemistry_jee_mains_sysllabus.pdf',
    '/JEE Mains syllabus/maths_jee_mains_sysllabus.pdf'
  ];

  intads() async {
    InterstitialAd.load(
        adUnitId: "ca-app-pub-6749113501960121/3278849313",
  ...
  void initState() {
    ...
    _bannerAd = BannerAd(
      ...
      adUnitId: "ca-app-pub-6749113501960121/2157339330",
      request: AdRequest(),
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: brandName("Jee Mains Syllabus", context),
        ),
      ),
      body: SafeArea(
        child: Stack(
